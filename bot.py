...
# Fungsi untuk menjalankan web server
def run_server():
    port = int(os.environ.get('PORT', 5000))  # Gunakan port dari variabel lingkungan jika tersedia
    app.run(host='0.0.0.0', port=port)  # Ubah host menjadi '0.0.0.0' untuk membuat server dapat diakses secara publik

if __name__ == "__main__":
    try:
        # Membuat thread untuk menjalankan web server
